...
namespace FriendStorage.UI.Wrapper
{
    public class FriendWrapper : ModelWrapper<Friend>
    {
        ...
        public int FriendGroupId { get => GetProperty<int>(); set => SetProperty(value); }
        ...
        public DateTime? Birthday { get => GetProperty<DateTime?>(); set => SetProperty(value); }
        ...
        public bool IsDeveloper { get => GetProperty<bool>(); set => SetProperty(value); }
